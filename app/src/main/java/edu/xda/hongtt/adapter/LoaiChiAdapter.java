...
//Hiển thị dữ liệu lên các item trong RecyclerView.adapter
...
//tái sử dụng kế thừa view
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            txtNameLoaiChi = itemView.findViewById(R.id.txtCustomNameLoaiChi);
            imgEdtLoaiChi = itemView.findViewById(R.id.imgCustomEditLoaiChi);
            imgDeleteLoaiChi = itemView.findViewById(R.id.imgCustomDeleteLoaiChi);
        }
    }

// tạo ra một RecyclerView.ViewHolder và khởi tạo 1 số trường sử dụng view
    @Override
    public LoaiChiAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = mLayoutInflater.inflate(R.layout.custom_loai_chi,parent,false);
        return new LoaiChiAdapter.MyViewHolder(item);
    }
//cập nhật RecyclerView.ViewHolder
    @Override
